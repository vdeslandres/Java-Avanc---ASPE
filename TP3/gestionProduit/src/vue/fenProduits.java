...
Question 1 : 
<user code> s'afiche maintenant à la place de la liste d'items.

Question 2: 
La variable n'a pas été déclaré ce qui pose problème. On le résout en choisissant " create field" dans les proposition de l'IDE.

Question3:
La barre de menu a été ajouté et les labels sont modifiés. Cependant, les boutons du menu ne sont pas cliquables.

Question 4:
Au niveau  de l'onglet "accessibility", on constate qu'il y a maintenant un parent, permettant donc l'accès.
...
private void btSupprMouseEntered(java.awt.event.MouseEvent evt) {                                     
